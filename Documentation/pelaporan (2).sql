...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 26, 2016 at 11:43 AM
...
CREATE TABLE IF NOT EXISTS `nearmiss` (
  `id_nearmiss` int(11) NOT NULL AUTO_INCREMENT,
  `id_operator` int(11) DEFAULT NULL,
  `id_supervisi` int(11) DEFAULT NULL,
  `tanggal_nearmiss` date DEFAULT NULL,
  `lokasi_nearmiss` text,
  `nama_saksi_nearmiss` text,
  `perbuatan_dilakukan_nearmiss` text,
  `tahapan_kejadian_nearmiss` text,
  `penyebab_nearmiss` text,
  `penjelasan_penyebab_nearmiss` text,
  `bukti_1` text,
  `bukti_2` text,
  PRIMARY KEY (`id_nearmiss`)
...
INSERT INTO `nearmiss` (`id_nearmiss`, `id_operator`, `id_supervisi`, `tanggal_nearmiss`, `lokasi_nearmiss`, `nama_saksi_nearmiss`, `perbuatan_dilakukan_nearmiss`, `tahapan_kejadian_nearmiss`, `penyebab_nearmiss`, `penjelasan_penyebab_nearmiss`, `bukti_1`, `bukti_2`) VALUES
(1, 1, 1, '2016-06-27', '', '', '', '', '', '', '', '');
...
--
-- Dumping data for table `preoperation`
--

INSERT INTO `preoperation` (`id_preOperation`, `id_operator`, `id_supervisi`, `id_headtruck`, `tanggal_preOperation`, `keterangan_preOperation`, `status_preOperation`, `updated_at`, `pertanyaan_1`, `pertanyaan_2`, `pertanyaan_3`, `pertanyaan_4`, `pertanyaan_5`, `pertanyaan_6`, `pertanyaan_7`, `pertanyaan_8`, `pertanyaan_9`, `pertanyaan_10`, `pertanyaan_11`, `pertanyaan_12`, `pertanyaan_13`, `pertanyaan_14`, `pertanyaan_15`, `pertanyaan_16`, `pertanyaan_17`, `pertanyaan_18`, `pertanyaan_19`, `pertanyaan_20`, `pertanyaan_21`, `pertanyaan_22`, `pertanyaan_23`, `pertanyaan_24`, `pertanyaan_25`, `pertanyaan_26`) VALUES
(1, 1, 1, 'VV - 130', '2016-06-22', '', 1, '2016-06-26', 'maks', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(2, 7, 1, 'VV - 134', '2016-06-26', '-', 0, '2016-06-26', 'maks', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', ''),
(3, 30, 1, 'VV - 146', '2016-06-26', '1', 0, '2016-06-26', 'min', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '');
...
CREATE TABLE IF NOT EXISTS `supervisi` (
  ...
  `nama_supervisi` varchar(100) NOT NULL,
  `jenis_supervisi` varchar(20) NOT NULL,
...
INSERT INTO `supervisi` (`id_supervisi`, `nama_supervisi`, `jenis_supervisi`) VALUES
(1, 'BURHAN', 'OPERATOR'),
(2, 'RIDWAN', 'MEKANIK'),
(3, 'RUDI', 'K3');
